...
const handleReset = async () => {
  ...
  try {
    ...
    // Check the status code directly (if successful, status will be 200)
  ...
  <div class="auth-wrapper d-flex align-center justify-center pa-4">
    <div class="position-relative my-sm-16">
      ...
      >
        ...
        <VCardText>
          <h4 class="text-h4 mb-1">Reset user</h4>
          <p class="mb-0">Please enter the email address of the account you'd like to reset</p>
        </VCardText>

        <VCardText>
          <VForm @submit.prevent="handleReset">
            <VRow>
              <!-- email -->
              <VCol cols="12">
                <VTextField
